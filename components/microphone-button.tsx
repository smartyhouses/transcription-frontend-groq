...
export const MicrophoneButton = ({
	...
	return (
		<div
			className={`flex items-center justify-center gap-2 rounded px-2 py-[6px] bg-white rounded-sm text-groq-accent-text hover:text-groq-accent-text-active active:translate-y-[2px] active:scale-[0.99] hover:-translate-y-[2px] transition-all ease-out duration-250 ${isSpaceBarPressed
		...
		>
			<TrackToggle
				...
				showIcon={false}
			>
				{isMuted ? <MicOff className="w-4 h-4 text-groq-accent-text" /> : <Mic className="w-4 h-4 text-groq-accent-text" />}
