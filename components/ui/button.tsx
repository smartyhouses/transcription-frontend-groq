...
export function Button({
	...
	switch (state) {
		...
		case "dropdown":
			buttonStyles = "bg-white rounded-sm text-groq-accent-text hover:text-groq-accent-text-active";
			break;
	...
	return (
		<button
			className={`active:translate-y-[2px] active:scale-[0.99] hover:-translate-y-[2px] flex flex-row ${disabled ? "pointer-events-none" : ""
